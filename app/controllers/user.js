...
var handlebarsOptions = {
  viewEngine: {
    extName: ".html",
    partialsDir: path.resolve("api-cendekia", "../app/templates"),
    layoutsDir: path.resolve("api-cendekia", "../app/templates"),
    defaultLayout: "",
  },
  viewPath: path.resolve("api-cendekia", "../app/templates"),
  extName: ".html",
};
...
exports.index = function (req, res) {
  return res.sendFile(
    path.resolve("api-cendekia", "../html-template/home.html")
  );
};

exports.render_forgot_password_template = function (req, res) {
  return res.sendFile(
    path.resolve("api-cendekia", "../html-template/forgot-password.html")
  );
};

exports.render_reset_password_template = function (req, res) {
  return res.sendFile(
    path.resolve("api-cendekia", "../html-template/reset-password.html")
  );
};
